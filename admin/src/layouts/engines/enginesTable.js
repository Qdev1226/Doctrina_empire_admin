...
const EnginesTable = ({ open, setOpen, currentId, setCurrentId, searchKey, selectedCategory }) => {
  ...
  const cellStyle = { fontSize: 14, borderBottom: 'none', padding: '12px 8px', textAlign: 'left', color: '#7B809A' }
    ...
    <Table aria-label="custom pagination table">
      <TableHead style={{ display: 'table-header-group' }}>
        <TableRow style={{ borderBottom: '1px solid #ddd' }}>
          ...
          <TableCell style={{ ...headerStyle, width: '10%', textAlign: 'center' }}>ACTION</TableCell>
        </TableRow>
      </TableHead>
      <TableBody >
        {rows.length > 0 &&
